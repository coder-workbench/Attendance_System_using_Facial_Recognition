...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket': "faceattendancerealtime-5ec7c.appspot.com"
})
    ...
    if faceCurFrame:
        ...
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            if matches[matchIndex]:
               ...
               # creating face detection square
               y1, x2, y2, x1 = faceLoc
               ...
               if counter == 0:
                   cvzone.putTextRect(imgBackground, "Loading", (200,400))
                ...
                if modeType != 3:
                    ...
                    if counter <= 10:
                        ...
                        cv2.putText(imgBackground, str(studentInfo["Starting_year"]), (1125, 625),
                                    cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                        cv2.putText(imgBackground, str(studentInfo["Roll_no"]), (910, 625),
                                    cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
